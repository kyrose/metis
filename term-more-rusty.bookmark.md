# My terminal became more Rusty 🦀 — Mahmoud Ashraf (www.mahmoudashraf.dev)

<https://www.mahmoudashraf.dev/blog/my-terminal-became-more-rusty/>

## Description

CLI tools written in rust make my terminal fast and productive

## Tags

#rustcli #alacritty #exa #zoxide #rg #tldr-cli
...
# My terminal became more Rusty 🦀 {#My%20terminal%20became%20more%20Rusty%20%F0%9F%A6%80}
...
Alacritty doesn\'t come with ligature support but you can use this [fork](https://github.com/zenixls2/alacritty/tree/ligature). or if you are using Arch you can install it from [aur](https://aur.archlinux.org/packages/alacritty-ligatures/)
...
and there is a ton of CLIs and tools written in rust you can check [lib.rs/command-line-utilities](https://lib.rs/command-line-utilities)
